...
\address{https://www.github.com/orenmazor}
\address{https://stackoverflow.com/users/118131/oren-mazor}
\address{https://www.linkedin.com/in/orenmazor/}
...
Network Security, Internet of Things, Usability, and Ubiquitous Computing.
...
\employer{\textbf{RaCharge Payments}}
...
\item Implemented SRE principles to monitor security and performance on a variety of services provided to merchants and customers using modern industry stdards (statsd, newrelic, pagerduty).
\item Worked on BFCM preparations for checkouts, a variety of strategies for improving throughput and managing complex business logic flows that are externals bound (e.g. stripe, avalara, ups, shopify).
\item Implemented a backgrounding mechanism based on Python's RQ (with healthy ripping off of Resque/Sidekiq mechanisms, as RQ is relatively barebones). Added exponential and a variety of LRU backoff strategies to accomodate external resource throttles.
\end{itemize}
\end{position}
