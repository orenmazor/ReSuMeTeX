...
\emph{Technical Interests}: Containers, Managing Big-Data Clusters, Frameworks and Middleware, Dynamically Typed Languages.
...
\item Worked on dockerizing the codebase and migrated the infrastructure from an adhoc deploy supervisorctl/runit method to a dockerized cluster managed.
